...
export default function Navbar() {
    return (
        <header className="w-full bg-neutral-100 p-8">
            <div className='max-w-[1150px] m-auto flex justify-between items-center gap-10'>
                <div>
                ...
                <nav>
                    <ul className="flex gap-9 text-lg">
                        ...
                        <li><a href="#">Bağış Kültürü</a></li>
                        <li><a href="#">Blog</a></li>
                        <li><a href="#">Kendi Paketini Oluştur!</a></li>
                    </ul>
                </nav>
