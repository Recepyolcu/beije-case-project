...
import { RiShoppingBagLine, RiArrowRightSLine } from 'react-icons/ri';


const anchorClass = "block w-full py-2 after:duration-300 after:content-[''] after:w-full after:opacity-0 after:bg-black after:h-[1px] after:block hover:after:opacity-100";
...
export default function Navbar() {
    ...
    return (
        <header className="fixed z-30 w-full bg-neutral-100">
            ...
            <div className={(menu && isMobile) ? 'flex w-full shadow-xl p-8' : 'hidden'}>
                <nav className='mt-5 w-full h-fit'>
                    <ul className="flex flex-col gap-5 text-lg">
                        <li className='w-full flex justify-between items-center'><a className="w-full block hover:underline" href="#">Ürünler</a><RiArrowRightSLine className='text-3xl'/></li>
                        <li className='w-full flex justify-between items-center'><a className="w-full block hover:underline" href="#">Biz Kimiz</a><RiArrowRightSLine className='text-3xl'/></li>
                        <li className='w-full flex justify-between items-center'><a className="w-full block hover:underline" href="#">Bağış Kültürü</a><RiArrowRightSLine className='text-3xl'/></li>
                        <li className='w-full'><a className="w-full block hover:underline" href="#">Blog</a></li>
                        <li className='w-full'><a className="w-full block hover:underline" href="#">Kendi Paketini Oluştur!</a></li>
                    </ul>
                </nav>
            </div>
        </header>
