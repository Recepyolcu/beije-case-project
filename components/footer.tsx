...
export default function Footer() {
    return (
        <footer className="max-mobile:px-10 max-mobile:items-center bg-footer-bg w-full px-[144px] py-[80px] flex flex-col gap-16 text-gray">
            <div className="max-mobile:flex-col flex gap-8">
                <div className="max-mobile:flex-col flex min-w-[517px]">
                    <div className="max-mobile:items-center flex flex-col gap-6">
                        <div>
                        ...
                        <div className='max-mobile:flex max-mobile:flex-col max-mobile:items-center gap-2'>
                        ...
                        <div className="w-full">
                            <form className="max-mobile:flex max-mobile:flex-col w-full flex gap-4" action="">
                ...
                <div className="max-mobile:flex-col max-mobile:gap-16 flex gap-10 justify-center w-full text-white">
                    <nav className='max-mobile:justify-evenly flex gap-16'>
                        <ul className="max-mobile:items-center flex flex-col gap-6">
                        ...
                        <ul className='max-mobile:flex-row max-mobile:justify-evenly max-mobile:w-full flex flex-col gap-6'>
                            ...
                            <li>
                                <a className='flex items-center gap-3' href="https://www.linkedin.com/company/beije-tr/?originalSubdomain=tr">
                                    ...
                                    <p className='max-mobile:hidden'>Linkedin</p>
                                </a>
                            </li>
                            <li>
                                <a className='flex items-center gap-3' href="https://open.spotify.com/user/ma20bga4ewhwt96kx1p92f2uv">
                                    ...
                                    <p className='max-mobile:hidden'>Spotify</p>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div className="max-mobile:w-full flex flex-col border-t-2 border-dark-gray">
                <div className='max-mobile:flex-col max-mobile:w-full max-mobile:text-center max-mobile:gap-12 max-mobile:items-center mt-[30px] mb-[60px] flex justify-between text-dark-gray text-[13px]'>
                    <div className='max-mobile:flex max-mobile:flex-col max-mobile:gap-3'>
                        <div className='font-semibold'>2023 beije. Tüm hakları saklıdır.</div>
                        <ul className='max-mobile:flex-col max-mobile:gap-3 flex gap-6 font-medium'>
