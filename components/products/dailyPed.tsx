    ...
    return (
        <div className="flex flex-col gap-5 relative bottom-7">
            <label className="flex flex-col gap-6" htmlFor="günlükPed">
                ...
                <span className="text-black px-3 py-1 rounded-md w-fit bg-[rgba(0,0,0,0.5)] flex justify-center">{context.data.günlük[1]}</span>
            ...
            <label className="flex flex-col gap-6" htmlFor="süperGünlükPed">
                ...
                <span className="text-black px-3 py-1 rounded-md w-fit bg-[rgba(0,0,0,0.5)] flex justify-center">{context.data.süperGünlük[1]}</span>
