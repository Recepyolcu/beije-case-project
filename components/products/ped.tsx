    ...
    return (
        <div className="flex flex-col relative bottom-16">
            <label className="flex flex-col gap-6" htmlFor="standart">
                ...
                <span className="text-black px-3 py-1 rounded-md w-fit bg-[rgba(0,0,0,0.5)] flex justify-center">{context.data.standart[1]}</span>
            ...
            <label className="flex flex-col gap-6" htmlFor="süperPed">
                ...
                <span className="text-black px-3 py-1 rounded-md w-fit bg-[rgba(0,0,0,0.5)] flex justify-center">{context.data.süperPed[1]}</span>
            ...
            <label className="flex flex-col gap-6" htmlFor="süperPlusPed">
                <span className="font-normal text-lg">Süper+ Ped</span>
                <span className="text-black px-3 py-1 rounded-md w-fit bg-[rgba(0,0,0,0.5)] flex justify-center">{context.data.süperPlusPed[1]}</span>
